...
export default function ComptePage() {
  ...
  async function handleAvatarChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setProfile(prev => prev ? { ...prev, avatar_url: publicUrl } : { id: userId, full_name: null, company_name: null, phone: null, avatar_url: publicUrl, website: null, bio: null, goal_monthly_margin: 5000, goal_annual_revenue: 100000, goal_margin_per_vehicle: 2500, onboarding_completed: false, onboarding_progress: [], created_at: new Date().toISOString(), updated_at: new Date().toISOString() })
